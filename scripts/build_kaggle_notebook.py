...
md("# DD-PRiSM-plus — Step 1: set up and fetch all data",
   ...
   "> `figshare.com` included. The two DepMap files come from there, so supply them",
   "> yourself: download them in a browser, upload as a Kaggle Dataset, and attach it",
   "> with **Add Input → Datasets**. Step 4 finds them wherever they land."),
